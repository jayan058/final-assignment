...
export class ProjectileForTowers {
    ...
    constructor(startX: number, startY: number, targetX: number, targetY: number, peakHeight: number = 0) {
        this.x = startX;
        this.y = startY;
        this.startX = startX;
        this.startY = startY;
        ...
        this.speed = targetX > 384 ? 0.3 : 0.7;
        this.progress = 0;
        this.width = 25;
        this.height = 25;
    }
    ...
    update() {
        ...
        const totalDistance = Math.hypot(this.targetX - this.startX, this.targetY - this.startY);
